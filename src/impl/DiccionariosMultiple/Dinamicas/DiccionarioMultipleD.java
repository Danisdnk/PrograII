package impl.DiccionariosMultiple.Dinamicas;
...
public class DiccionarioMultipleD implements DiccionarioMultipleTDA {
    ...
    public void EliminarValor(int clave, int valor) {
        ...
        if ( origen != null ) {
            if ( origen.clave == clave ) {// es en el primero68.
                EliminarValorEnNodo(origen, valor);

                if ( origen.valores == null ) {// qued ́o vac ́ıo70.
                    origen = origen.sigClave;
                } else {// es en alg ́un otro
                    NodoClave aux = origen;
                    while (aux.sigClave != null && aux.sigClave.clave != clave) {
                        aux = aux.sigClave;
                    }
                    ...
                    if ( aux.sigClave != null ) {
                        ...
                        if ( aux.sigClave.valores == null )// qued ́o vac ́ıo
                            aux.sigClave = aux.sigClave.sigClave;
                    }
                }
            }
